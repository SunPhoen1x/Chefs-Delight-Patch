...
import com.phoen1x.chefsdelightpatch.impl.entity.model.EntityModelHelper;
...
public class SimpleElementHolder<T extends Entity, X extends EntityModel<T>> extends ElementHolder {
    ...
    public static final ResourceLocation MAIN_LAYER = ChefsDelightPatch.id("main_layer");
